...
var daughter1 = new Person("daughter1", nomP, "Adèle", 27, fem, "Agriculteur", father1, mother1, [son1, son2], [daughter2], "img/firstBornAv.png");
...
var son2 = new Person("son2", nomP, "Bruno", 19, masc, "Cuisinier", father1, mother1, [daughter2], [daughter1, daughter2], symHom);
var grandaughter1 = new Person("grandaughter1", "Tokeida", "Kimiyo", 8, fem, defaut, sonInLaw1, daughter1, [granson1], [grandaughter2], symFem);
var grandaughter2 = new Person("grandaughter2", "Tokeida", "Natsu", 6, fem, defaut, sonInLaw1, daughter1, [granson1], [grandaughter1], symFem);
var granson1 = new Person("granson1", "Tokeida", "Takao", 2, masc, defaut, sonInLaw1, daughter1, fsDefaut, [grandaughter1, grandaughter2], symHom);
var grandaughter3 = new Person("grandaughter3","Pommereau", "Laura", 2, fem, defaut, sonInLaw2, daughter2, fsDefaut, fsDefaut, symFem);
